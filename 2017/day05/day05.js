...
function run(jumpList, verbose){
    // copy to preserve original
    jumpList = jumpList.slice();
    var position = 0;
    var stepCount = 0;
    if (verbose === true) printCase(jumpList, position);
    while (position >= 0 && position < jumpList.length){
        var value = jumpList[position];
        jumpList[position] += 1;
        position += value;
        if (verbose === true) printCase(jumpList, position);
        stepCount++;
...
console.log('\n---- part 1 ----\n');
console.log('test step count', run(testInput, true));
console.log('real step count', run(input, false));


function run2(jumpList, verbose){
    // copy to preserve original
    jumpList = jumpList.slice();
    var position = 0;
    var stepCount = 0;
...
console.log('test step cont', run2(testInput, true))
console.log('real step cont', run2(input, false))